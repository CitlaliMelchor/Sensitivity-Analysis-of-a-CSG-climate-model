function angle = solaraltBo( t,day_num,hour,location )
%solaralt: solar altitude according to time and location.
%give the t=simulation time, day_num-day number, start time (hour) and location(latitude,longitude,hourcircle), ans=[solar altitude,time angle, solar declination].
